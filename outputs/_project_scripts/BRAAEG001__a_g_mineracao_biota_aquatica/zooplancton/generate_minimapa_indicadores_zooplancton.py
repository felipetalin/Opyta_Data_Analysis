...
OUTPUT_DIR = CLIENT_ROOT / "resultados" / "migracao_biota" / "zooplancton"
AUDIT_DIR = Path("outputs/_project_scripts/BRAAEG001__a_g_mineracao_biota_aquatica/zooplancton")
