#!/usr/bin/env python
"""
Reproducer script for Ictiofauna analysis - braaeg001
Generated: 2026-07-13T16:26:07.149901Z
...
def main():
    ...
    parser.add_argument("--output-dir", default=r"G:\Meu Drive\Opyta\Clientes\Clientes\Clientes\Brandt\A&G Mineração\resultados\migracao_biota\ictiofauna", help="Output directory for generated artifacts")
    ...
    campaigns = [c.strip() for c in args.campaigns.split(",") if c.strip()] if args.campaigns else ['C001-2026-02-CH', 'C002-2026-06-SC']
    ...
    params = RunParams(
        ...
        block=args.block,
        audit_project_slug='BRAAEG001__a_g_mineracao_biota_aquatica',
        campaigns=campaigns,
    )
