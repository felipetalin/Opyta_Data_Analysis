...
def run_meio_fisico_xlsx_pipeline(
    ...
    **kwargs,
    ...
    generated: List[str] = []
    if out_root.exists():
        for pattern in ("**/*.png", "**/*.xlsx", "**/*.txt", "**/*.json"):
