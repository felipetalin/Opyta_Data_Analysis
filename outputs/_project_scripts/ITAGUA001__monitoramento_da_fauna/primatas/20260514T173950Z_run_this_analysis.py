...
Generated: 2026-05-14T17:39:50.743817Z
...
def main():
    ...
    parser.add_argument("--block", default='fig17', help="Block to execute (default: fig17)")
    parser.add_argument("--output-dir", default=r"G:\Meu Drive\Opyta\Clientes\Clientes\Clientes\Itatiaia\Guanhães Energia\Resultados e análises\28_campanha-Abril_26\Primatas\Dores de Guanhães", help="Output directory for generated artifacts")
