...
- Cadastro de especies: nao informado

## Veredito

**Nao importar ainda.** Foram encontrados **10 bloqueios** e **5 avisos**.
...
- **UNKNOWN_SPECIES** | linhas: 41: Total de 1 espécie(s) desconhecida(s) nos resultados. Bloqueio ativado: revise o cadastro mestre ou confirme que as espécies estão presentes na aba 'Especies' da mesma planilha.
...
- **COORDINATE_REFERENCE_EMPTY** | aba: Pontos_e_Campanhas: Nenhum ponto foi lido da referencia de coordenadas: G:\Meu Drive\Opyta\Clientes\Clientes\Clientes\Brandt\Cedro Mineração\geo\Geo_Fonseca\Anteriores\Unidades Amostrais - Fonseca - Fauna Aquática.kmz
...
- Cadastro de especies ainda nao informado.

## Arquivos gerados
- Excel detalhado: `outputs\_project_scripts\BRACED001__fonseca_biota_aquatica\ictiofauna\validation\validacao_braced001_fonseca_ictiofauna_20260813.xlsx`
- JSON: `outputs\_project_scripts\BRACED001__fonseca_biota_aquatica\ictiofauna\validation\validacao_braced001_fonseca_ictiofauna_20260813.json`