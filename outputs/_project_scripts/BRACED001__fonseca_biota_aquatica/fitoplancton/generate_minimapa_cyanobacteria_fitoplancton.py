...
DEFAULT_OUTPUT_DIR = CLIENT_ROOT / "Produtos" / "Resultados" / "Fitoplancton"
OUTPUT_DIR = Path(os.environ.get("BRACED001_FITO_OUTPUT_DIR", str(DEFAULT_OUTPUT_DIR)))
AUDIT_DIR = Path("outputs/_project_scripts/BRACED001__fonseca_biota_aquatica/fitoplancton")
...
def main() -> int:
    ...
    source_xlsx = os.environ.get("BRACED001_FITO_MINIMAP_SOURCE_XLSX")
    if source_xlsx:
