#!/usr/bin/env python
"""
Reproducer script for Zoobentos analysis - braavg002
Generated: 2026-06-08T14:42:36.215780Z
...
def main():
    ...
    parser.add_argument("--output-dir", default=r"G:\Meu Drive\Opyta\Clientes\Clientes\Clientes\Brandt\AVG\Produtos\Planilha Consolidada\Resultados e planilhas\Resultados bentos\2026", help="Output directory for generated artifacts")
    ...
    params = RunParams(
        ...
        block=args.block,
        audit_project_slug='avg_bentos_2026',
    )
