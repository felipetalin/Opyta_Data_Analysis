...
Este painel mostra identidade e estado permanente dos projetos. Para saber em
qual etapa uma campanha ou rodada de trabalho esta, consulte
[ACTIVE_OPERATIONS.md](ACTIVE_OPERATIONS.md).
