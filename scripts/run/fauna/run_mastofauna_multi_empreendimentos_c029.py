...
import opyta_analysis.pipelines.diagnostico.mastofauna as masto_mod
...
def _default_output_dir() -> Path:
    ...
    return project_dir / "Resultados e an\u00e1lises" / "29_campanha_Jul_26" / "Mastofauna"


def main() -> int:
    _install_c029_layout_theme()

    base_out = Path(os.environ.get("MASTOFAUNA_C029_OUTPUT_DIR", str(_default_output_dir())))
    ...
    for pch_name, folder_name in targets:
        ...
        masto_mod.TARGET_PCH_NAME = pch_name
        masto_mod.TARGET_CONTROL_NAME = "\u00c1rea Controle"
